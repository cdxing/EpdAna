#ifndef StPhiConstants_h
#define StPhiConstants_h
#include "TString.h"
#include "Rtypes.h"
#include <map>
...
class TriFlow
{
  ...
  static Float_t pt_low[19];
  static Float_t pt_up[19];
  static Float_t pt_low_spectra[32];
  static Float_t pt_up_spectra[32];
  static Float_t x_low[19];
  static Float_t x_up[19];
  static Float_t y_low[19];
  static Float_t y_up[19];

  static Int_t cent_low[4]; // shaowei
  static Int_t cent_up[4]; // shaowei
