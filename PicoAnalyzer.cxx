                    ...
                    )
{
  ...
  Double_t etaRange[mEpOrderMax][_nEventTypeBins] = {{-5.0,-4.4,-4.35,-3.95,-2.60},{5.0,-4.4,-4.35,-3.95,-2.60}};
  ...
  // -------------------------- TPC event planes ----------------------------------
  Double_t etaRange_tpc[mEpOrderMax][_nEventTypeBins_tpc] = {{-2.0,-1.4,-1.0,-0.6,0.},{-2.0,-1.4,-1.0,-0.6,0.}}; // TPC eta range {-0.4, 0.0}
